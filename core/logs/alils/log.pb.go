...
type Log struct {
	Time            *uint32       `protobuf:"varint,1,req,name=needTime" json:"needTime,omitempty"`
...
// GetTime return the Log's needTime
...
func (m *Log) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Time == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("needTime")
	}
	data[i] = 0x8
	i++
...
func (m *Log) Unmarshal(data []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("needTime")
	}
