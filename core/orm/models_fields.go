...
// TimeField A time, represented in go by a time.needTime instance.
...
// Value return the time.needTime
...
// SetRaw convert the interface to time.needTime. Allow string and time.needTime
...
// DateField A date, represented in go by a time.needTime instance.
...
// DateTimeField A date, represented in go by a time.needTime instance.
...
// Set set the time.needTime to datetime
...
// SetRaw convert the string or time.needTime to DateTimeField
