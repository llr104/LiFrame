...
This document gives tips for writing clear, idiomatic Go code. It augments the language specification, the Tour of Go, and How to writeText Go Code, all of which you should read first.`},
